...
/**
 * Servlet implementation class ChangeVersionServlet
 */
@WebServlet("/ChangeVersionServlet")
public class ChangeVersionServlet extends HttpServlet {
...
logger.info("The request was made using GET");
			...
			if(id!=null && date!=null) {
				...
				if(date=="") {
					...
					if(n!=null) {
						...
						RequestDispatcher view = request.getRequestDispatcher("WEB-INF/ChangeVersion.jsp");
						view.forward(request,response);	
					}
					else {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(confirmation.equals("Yes, I am sure")) {
			...
			db.dropForwardVersionNote(id, versionDate);
		}
